...
public class Menu {
    ...
    private void addNewAnimal() {
        ...
        Animals animals;
        switch (animalClass) {
            case 1 -> animals = new Dogs(name, skills);
            case 2 -> animals = new Cats(name, skills);
            case 3 -> animals = new Hamsters(name, skills);
            case 4 -> animals = new Donkeys(name, skills);
            case 5 -> animals = new Horses(name, skills);
            default -> {
